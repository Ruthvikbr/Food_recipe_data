...
VALUES
    ...
    ('username5', 'user5@example.com', 'password5', '5551234567', 'Jon', 'Brown', '1992-03-10', 'profilepic5.jpg', 'Bio for user 5'),
    ...
    ('username10', 'user10@example.com', 'password10', NULL, 'Broos', 'Lee', '1993-11-22', 'profilepic10.jpg', NULL);
